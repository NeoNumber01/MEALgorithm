    ...
    return (
        <button
            ...
            className="w-full flex items-center justify-center gap-3 px-4 py-3 bg-white border border-gray-200 
                rounded-xl font-medium text-gray-700 hover:bg-gray-50 hover:border-gray-300 
                transition-all shadow-sm hover:shadow"
        >
            {providerIcons[props.provider]}
            <span>Continue with {providerNames[props.provider]}</span>
        </button>
    )
}
